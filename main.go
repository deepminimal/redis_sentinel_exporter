...
var (
	...
	sentinelTLSCaCertFile       = flag.String("sentinel.tls-ca-cert-file", GetStringEnv("SENTINEL_TLS_CA_CERT_FILE", ""), "Name of the CA certificate file (including full path) if the server requires TLS client authentication.")
	sentinelTLSClientCertFile   = flag.String("sentinel.tls-client-cert-file", GetStringEnv("SENTINEL_TLS_CLIENT_CERT_FILE", ""), "Name of the client certificate file (including full path) if the server requires TLS client authentication.")
	sentinelTLSClientKeyFile    = flag.String("sentinel.tls-client-key-file", GetStringEnv("SENTINEL_TLS_CLIENT_KEY_FILE", ""), "Name of the client key file (including full path) if the server requires TLS client authentication.")
